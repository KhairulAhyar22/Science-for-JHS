    ...
    <div class="container">
      <div class="inner-container-bab">
        <div class="btn-detail-bab">
          ...
          <button class="tandai-materi">Tandai Dipelajari</button>
        </div>
        <div class="container-materi-bab">
          <h2 class="title-materi-bab">Keadaan Alam dan Aktivitas Penduduk Indonesia</h2>
          <h3 class="title-smb1">A. Letak Wilayah dan Pengaruhnya Bagi Keadaan Alam Indonesia</h3>
          <p class="text-smb">Letak suatu tempat di permukaan bumi tidak hanya sekadar posisi suatu objek di permukaan bumi, tetapi juga karakteristik yang ada pada tempat tersebut. Setiap tempat akan menunjukkan perbedaan dengan tempat lainnya di permukaan bumi.</p>
          <div class="box-sub">
            <h4 class="title-smb2">1. Letak Astronomis</h4>
            <p class="text-smb">Letak astronomis adalah letak suatu tempat berdasarkan garis lintang dan garis bujurnya. Garis lintang adalah garis khayal yang melintang melingkari bumi. Garis bujur adalah garis khayal yang menghubungkan Kutub Utara dan Kutub Selatan.
